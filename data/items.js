...
window.ITEMS = [
  ...
  },
  {
    ...
    "title": "Автокресло-бустер Graco TurboBooster (гр. 2-3, 15–36 кг)",
    "category": "Детские товары",
    "brand": "Graco",
    "model": "TurboBooster",
    "year": 2012,
    "condition": "Рабочее, продаётся как есть. Выпуск 2012 г., серый. Бюджетный вариант.",
    "specs": [
    ...
    "description": "Автокресло-бустер Graco группы 2-3 для детей весом 15–36 кг (примерно 4–10 лет). Приподнимает ребёнка, чтобы штатный автомобильный 3-точечный ремень проходил правильно — по плечу и бёдрам. Собственных ремней не имеет, ребёнка фиксирует штатный ремень авто.\n\nСостояние рабочее, продаётся как есть. ⚠️ Выпуск 2012 г. — кресло старше типового срока службы автокресел (обычно 6–10 лет от даты выпуска), поэтому это бюджетный вариант; указываю честно.",
    "priceNewKzt": 25000,
    "priceNewSource": "модель снята с производства; новый бустер этого класса в РК ~20–40 тыс. ₸ (Marwin/happys), июль 2026",
    "priceOursKzt": 6000,
    "discountPct": 76,
    "photos": [
